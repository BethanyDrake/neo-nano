...
const initAwards = async () => {
 ...
 end_date date
  ...
  await sql`insert into awards (title, description, image_url, requirement_unit, requirement_value, start_date, end_date) values
    ('Starting Strong', 'Wrote at least 1667 words on November 1st', 'https://ytw3r4gan2ohteli.public.blob.vercel-storage.com/badges/starting%20strong.svg', 'words', 1667, '2025-11-01', '2025-11-01'),
