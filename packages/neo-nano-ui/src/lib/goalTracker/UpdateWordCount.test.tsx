...
describe("<UpdateWordCount />", () => {
    test('update goal progress', async () => {
        ...
        const { getByRole} = render(<UpdateWordCount setRecords={vi.fn()} isCumulative={false} id={"goal-id"} records={[null]} startDate={getDateAsString(startOfToday())} lengthDays={1} />)
