...
export const SmallIconButton = ({id, text, onClick, icon, isLoading, variant}: {id: string, text:string, isLoading?: boolean, variant?: 'angry'} & Pick<DOMAttributes<HTMLButtonElement>, 'onClick'> & Pick<FontAwesomeIconProps, 'icon'>) => {
