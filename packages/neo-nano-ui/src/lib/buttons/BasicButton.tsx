...
export const BasicButton = ({buttonProps, children, variant, isLoading}: PropsWithChildren & {isLoading?: boolean, variant?: 'angry' | 'glow', buttonProps?: DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>} ) => {
